...
import BTCTransactionServices from "../../services/aaa/BtcTransactionService";
...
const GetBTCWalletDetailsById = data => async dispatch => {
  ...
  await BTCTransactionServices
    .getBTCTransactionDetails({...data, userId})
    .then((response) => {
      dispatch({
...
const InitialBTCSellToExternalWalletTransaction = data => async dispatch => {
  const userId = localStorage.getItem(actionTypes.AUTH_TOKEN_ID);
  dispatch({
  ...
  await BTCTransactionServices
    .initialSendBTCToExternalWallet({userId}, data)
    .then((response) => {
      dispatch({
...
export const initialBTCSellToExternalWalletTransaction = data => dispatch => {
